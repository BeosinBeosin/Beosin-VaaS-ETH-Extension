...
EXTENSION_IDENT="beosin.beosin-vaas-eth"
TOOL_NAME="Beosin-VaaS"
TOOL_PATH=${TOOL_NAME}
...
TOOL_SAVE_PATH="${HOME}/.vscode/extensions/$(cd ${HOME}/.vscode/extensions;ls | grep ${EXTENSION_IDENT})/${TOOL_NAME}" 
[ -e "${TOOL_SAVE_PATH}" ] && _do rm -rf "${TOOL_SAVE_PATH}" && sleep 1
_do cp -rf "${TOOL_PATH}" "${TOOL_SAVE_PATH}"
_do chmod -R 777 "${TOOL_SAVE_PATH}"
# 打开vscode
# _do code
echo -e "\n\t=========== Installed ===========\n"
